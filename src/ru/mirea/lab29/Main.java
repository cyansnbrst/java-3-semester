...
public class Main {
    public static void main(String[] args) {
        Dish dish1 = new Dish(1, "Soup", "Description1");
        Dish dish2 = new Dish(3, "Salad", "Description2");
        Dish dish3 = new Dish(3, "Pasta", "Description3");
        Drink dish4 = new Drink(3, "Juice", "Description4");
        Drink dish5 = new Drink(3, "Wine", "Description5");
